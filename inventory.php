...
$inventory = service::getInventory($token, $eventId);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="Navbar">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item"><a class="nav-link" href="/VetTix/search.php"><span
                                class="fa fa-search fa-lg"></span> Search</a></li>

                <li class="nav-item active"><a class="nav-link" href="/VetTix/events.php"><span
                                class="fa fa-ticket fa-lg"></span>
                        Events</a></li>
                </li>
            </ul>
        </div>
                        ...
                        <p class="card-text">
                            ...
                            foreach ($inventory as $ticket) {
                                printf(
                                    ...
                                    . '     <div class="card-body">'
                                    . '        <h5 class="card-title">Row: %s</h5>'
                                    . '        <p class="card-text">Seat: %s</p>'
                                    . '     </div>'
                                    . '  </div>'
                                    . '</div>'
                                    , $ticket->section
