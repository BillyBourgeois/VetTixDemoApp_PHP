            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        <?php echo $eventDetails->startDate . ' ' . $eventDetails->startTime; ?>
                        <br/>
                        <strong>Ends: </strong>
                        <?php echo $eventDetails->endDate . ' ' . $eventDetails->endTime; ?>
                        <br/>
                        <strong>Available Tickets: </strong>
                        <?php echo $eventDetails->ticketsAvailable . ' of ' . $eventDetails->totalTickets; ?>
                        <br/>
                        <strong>Request Type: </strong>
                        <?php echo $eventDetails->ticketRequestsStatus; ?>
                        <br/>
                        <strong>Delivery Method: </strong>
                        <?php echo $eventDetails->deliveryMethod; ?>
                        <br/>
                        <strong>Special Instructions: </strong>
                        <?php echo $eventDetails->specialInstructions; ?>
                        <br/>
                        <strong>Venue: </strong><br/>
                        <small>
                            <?php echo $eventDetails->venueStreet1; ?>
                            <?php echo $eventDetails->venueStreet2; ?><br/>
                            <?php echo $eventDetails->venueCity . ', ' . $eventDetails->venueStateCode . ' ' . $eventDetails->venuePostalCode; ?>
                            <br/>
                        </small>
                        <strong>Shipping Cost: </strong>
                        <?php echo $eventDetails->shippingCost; ?>
                        <br/>
                        <strong>Min/Max Tickets: </strong>
                        <?php echo $eventDetails->minimumTickets . ' to ' . $eventDetails->maximumTickets; ?>
                        <br/>
                    </p>
                </div>
            </div>
