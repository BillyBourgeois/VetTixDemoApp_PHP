...
$sortBy = $_GET["sortBy"] ?? "";
$eventsObject = service::getEvents($token, $eventTypeID, $stateCode, $eventStatus, $sortBy, 100, 1);
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="">
                <div class="table-responsive-md">
                    <table class="table table-striped table-dark table-sm">
                        ...
                        <tbody>
                        <?php
                        foreach ($eventsObject -> eventItems as $event) {
                            echo "<tr>";// $event -> title;
                            echo '<td width="150" class="align-middle">';
                            echo '<img width="200" class="card-img-top" src="' . $event->imageURL . '" alt="' . $event->title . '">';
                            echo '</td>';
                            ...
                            echo $event->startDate . ' ' . $event->startTime;
                            echo '</td>';

                            echo '<td class="align-middle">';
                            echo $event->endDate . ' ' . $event->endTime;
                            echo '</td>';

                            echo '<td class="align-middle">';
                            echo $event->city . ', ' . $event->stateCode;
                            echo '</td>';

                            echo '<td class="align-middle" align="center">';
                            echo $event->ticketsAvailable;
                            echo '</td>';

                            echo '<td width="200">
                            <div class="row mb-3 mt-1">
                                <div class="col-sm-5">
                                    <form class="" action="details.php" method="get">';
                                        echo '<input name="eventId" type="hidden" value="' . $event->id . '"/>';
                                        echo '<button type="submit" class="btn btn-primary btn-sm mr-2">
                                            Details
                                        </button>
                                    </form>
                                    </div>
                            ...
                            echo '<input name="eventId" type="hidden" value="' . $event->id . '"/>';
                                        echo '<button type="submit" class="btn btn-secondary btn-sm mr-2">
                                            Inventory
                                        </button>
                                    </form>
                                    </div>
                            ...
                            <div class="row mb-1">
                                <div class="">
                                    <form class="form col-sm-12" action="sittogether.php" method="get">
                                        <div class="input-group input-group-sm">';
                            echo '<input name="eventId" type="hidden" value="' . $event->id . '"/>';
                                        echo '<input type="number" min="2" max="10"  value= "2" class="form-control"
                                                   name="numberOfSeats"
