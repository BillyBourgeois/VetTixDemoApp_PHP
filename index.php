...
<div class="container">
    ...
    <form class="form form-horizontal" action="search.php" method="post">
        <div class="row">
            <div class="col-sm-8 mx-auto">
                    <div class="row">
                        <div class="form-group col-sm-5">
                            <label for="username">Email</label>
                            <input type="text" id="email" name="email" class="form-control" :class="{ 'is-invalid': submitted && !username }" placeholder="Enter email" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-5">
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control" :class="{ 'is-invalid': submitted && !password }" placeholder="Password" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
