...
$states = service::getStatesWithEvents($token);
$eventTypes = service::getEventTypes($token);
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="Navbar">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active"><a class="nav-link" href="/VetTix/index.php"><span class="fa fa-search fa-lg"></span> Search</a></li>

                <li class="nav-item"><a class="nav-link" href="/VetTix/events.php"><span class="fa fa-ticket fa-lg"></span>
                        Events</a></li>
                </li>
            </ul>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-7">
            <form class="form form-horizontal" action="events.php" method="get">
                <div class="">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="eventTypeID">Type</label>
                                <select name="eventTypeID" class="form-control" id="type">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="stateCode" class="form-control" id="type">
                                    <option value="">Any</option>
                                    <?php
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        <?php echo $userInfo->branchShortDescription . " - " . $userInfo->statusShortDescription ?>
                        <br/>
                        <strong>Coins: </strong>
                        <?php echo $userInfo->numCoins ?> <br/>
                        <strong>Site: </strong>
                        <?php echo $userInfo->siteName ?> <br/>
                        <br/>
                    </p>
                </div>
            </div>
